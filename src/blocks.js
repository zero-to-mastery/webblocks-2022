...
Shuffle(cards).forEach((c) => {
  contents.push([
    `<li class="card">` +
      ...
      `<img class="block-image" src='${c.block_icon}' alt='${c.name}' onerror="this.src='https://cdn.discordapp.com/attachments/870676772683919390/891310666596630538/coming-soon-logo_okok.png';"/>` +
      `</a>` +
